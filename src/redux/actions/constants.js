...
export const GET_RENTAL_ID = "GET_RENTAL_ID";
export const GET_ADMIN_FILTER_RESULT = 'GET_ADMIN_FILTER_RESULT';
export const GET_MAP_FILTER_RESULT = 'GET_MAP_FILTER_RESULT';
