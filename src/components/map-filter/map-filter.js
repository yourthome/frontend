...
import {getMapFilterData} from '../../redux/actions/actions';
...
const mapStateToProps = state => {
  return {
    data: state.getMapFilterData.data.filter(elem => elem.title.toLowerCase().includes(state.setSearchVal.search)),
